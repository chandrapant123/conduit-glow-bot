      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Powered by AI · Multi-Tenant · Enterprise-Ready</span>
          </motion.div>
          ...
          >
            Pipebot is the ultimate multi-tenant WhatsApp marketing automation engine built for agencies, SaaS founders, and enterprises.
          </motion.p>
        ...
        >
          ...
          <div className="rounded-2xl overflow-hidden border border-glass-border glow-blue">
            <img
              src={dashboardMockup}
              alt="Pipebot WhatsApp Marketing Dashboard showing campaign metrics, chat analytics, and contact management"
